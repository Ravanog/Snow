...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @KA42_Moviez" -metadata author="@TG_UPDATES1" -metadata:s:s title="Subtitled By :- @TG_Movie_Req_Grp" -metadata:s:a title="By :- @KA42_Moviez" -metadata:s:v title="By:- @TG_UPDATES1" """
        )
